...
export const mockLogin = (userName: string, password: string) =>
  new Promise<TokenResponse>(function(resolve, rejected) {
    setTimeout(() => {
      if (userName === "jcastillo@threepoints.com" && password === "aswd_10") {
        resolve({
          token:
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjgyOTM0ODIwOTM0ODkwODA5OCIsImVtYWlsIjoibHVjYXNmZXJuYW5kZXphcmFnb25AZ21haWwuY29tIiwiaWF0IjoxNjM2OTIzOTE4LCJleHAiOjE2MzY5Mjc1MTh9.3qHpT-ZKj04-QzkissGbuyCHFkgN_WXy8LkuXcrUUSw",
        });
      } else {
  ...
  new Promise<AboutMe>(function(resolve) {
    setTimeout(() => {
      resolve({
        id: "12389asdfasf8",
        name: "Juan Castillo",
        birthday: 688626000000,
        nationality: "Ecuador",
        occupation: "FullStack Developer",
        job: "Developer at Banco Pichincha",
        github: "https://github.com/juanfcreyes",
      });
    }, 500);
  });
